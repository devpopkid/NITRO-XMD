...
Matrix.ev.on('connection.update', (update) => {
    ...
    if (connection === 'close') {
        ...
        if (initialConnection) {
            console.log(chalk.green("Connected Successfully to Xtreme-Tech_X 🤍"));
            Matrix.sendMessage(Matrix.user.id, { 
                image: { url: "https://files.catbox.moe/3hrxbh.jpg" }, 
                caption: `*Hello there User! 👋🏻* 

> Simple, Straightforward, But Loaded With Features ♻️. Meet Xtreme-Tech_X WhatsApp Bot.

*Thanks for using Xtreme-Tech_X 🔗* 
...
https://github.com/Tappy-Black/Xtreme-Tech_X-AI
